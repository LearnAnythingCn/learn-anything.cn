...
import SearchResultList from "../templates/movie/searchResultList";

const { Search } = Input;
const axios = require('axios');

const SearchMovie = ({ location, data }) => {
  ...
  useEffect(
    () => {
      if (query) {
        ...
        axios.get(`https://api.learn-anything.cn/movies?${queryData}`)
          // {params:queryData})
...
export const searchMovieSite = graphql`
  query {
    site {
      siteMetadata {
        title
