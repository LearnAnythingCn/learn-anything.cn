...
const MovieDetailComputer = ({ toc, md, movie, tags, siteMetadata }) => {

  var title = movie.title, author = movie.author;

  const moment = require('moment')
  moment.locale('zh-cn');
  var time = moment(movie.published_at).format('YYYY-MM-DD HH:mm:ss');
...
export default MovieDetailComputer
